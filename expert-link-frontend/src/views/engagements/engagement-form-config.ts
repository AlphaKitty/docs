...
/** 活动名称 placeholder：按申请类别区分 */
export const ACTIVITY_NAME_PLACEHOLDER_BY_APPLY_TYPE: Record<string, string> = {
  专家调用: 'XX项目XX评审专家XX邀请',
  积分自提: '一句话概括您的成果，便于他人快速识别',
}

/** 活动需求信息 placeholder：按积分项目区分 */
export const ACTIVITY_INFO_PLACEHOLDER_BY_ITEM: Record<string, string> = {
  技术评审: '结构化填写提示文本待设计',
  人才评审: '结构化填写提示文本待设计',
  技术支持: `问题现象/不良率：
...
已排除的原因/方向：
当前无法突破的卡点：`,
  '行业/技术洞察': '【关联背景】：为解决什么问题或抓住什么机会而做？\n【具体交付物】：报告、代码库、SOP文档、课程PPT、会议纪要\n【量化数据】：覆盖人数、应用次数、节省成本、效率提升百分比等\n【实际影响描述】：对业务、团队、行业产生的可验证价值',
  技术成果推广: '【关联背景】：为解决什么问题或抓住什么机会而做？\n【具体交付物】：报告、代码库、SOP文档、课程PPT、会议纪要\n【量化数据】：覆盖人数、应用次数、节省成本、效率提升百分比等\n【实际影响描述】：对业务、团队、行业产生的可验证价值',
  人才标准建设: '【关联背景】：为解决什么问题或抓住什么机会而做？\n【具体交付物】：报告、代码库、SOP文档、课程PPT、会议纪要\n【量化数据】：覆盖人数、应用次数、节省成本、效率提升百分比等\n【实际影响描述】：对业务、团队、行业产生的可验证价值',
  专业论文: '【关联背景】：为解决什么问题或抓住什么机会而做？\n【具体交付物】：报告、代码库、SOP文档、课程PPT、会议纪要\n【量化数据】：覆盖人数、应用次数、节省成本、效率提升百分比等\n【实际影响描述】：对业务、团队、行业产生的可验证价值',
  知识产权: '【关联背景】：为解决什么问题或抓住什么机会而做？\n【具体交付物】：报告、代码库、SOP文档、课程PPT、会议纪要\n【量化数据】：覆盖人数、应用次数、节省成本、效率提升百分比等\n【实际影响描述】：对业务、团队、行业产生的可验证价值',
  项目经验沉淀: '【关联背景】：为解决什么问题或抓住什么机会而做？\n【具体交付物】：报告、代码库、SOP文档、课程PPT、会议纪要\n【量化数据】：覆盖人数、应用次数、节省成本、效率提升百分比等\n【实际影响描述】：对业务、团队、行业产生的可验证价值',
  知识库建设: '【关联背景】：为解决什么问题或抓住什么机会而做？\n【具体交付物】：报告、代码库、SOP文档、课程PPT、会议纪要\n【量化数据】：覆盖人数、应用次数、节省成本、效率提升百分比等\n【实际影响描述】：对业务、团队、行业产生的可验证价值',
  流程制度建设: '【关联背景】：为解决什么问题或抓住什么机会而做？\n【具体交付物】：报告、代码库、SOP文档、课程PPT、会议纪要\n【量化数据】：覆盖人数、应用次数、节省成本、效率提升百分比等\n【实际影响描述】：对业务、团队、行业产生的可验证价值',
  课程开发: '【关联背景】：为解决什么问题或抓住什么机会而做？\n【具体交付物】：报告、代码库、SOP文档、课程PPT、会议纪要\n【量化数据】：覆盖人数、应用次数、节省成本、效率提升百分比等\n【实际影响描述】：对业务、团队、行业产生的可验证价值',
  担任导师: '【关联背景】：为解决什么问题或抓住什么机会而做？\n【具体交付物】：报告、代码库、SOP文档、课程PPT、会议纪要\n【量化数据】：覆盖人数、应用次数、节省成本、效率提升百分比等\n【实际影响描述】：对业务、团队、行业产生的可验证价值',
  担任讲师: '【关联背景】：为解决什么问题或抓住什么机会而做？\n【具体交付物】：报告、代码库、SOP文档、课程PPT、会议纪要\n【量化数据】：覆盖人数、应用次数、节省成本、效率提升百分比等\n【实际影响描述】：对业务、团队、行业产生的可验证价值',
  '行业/业务交流': '【关联背景】：为解决什么问题或抓住什么机会而做？\n【具体交付物】：报告、代码库、SOP文档、课程PPT、会议纪要\n【量化数据】：覆盖人数、应用次数、节省成本、效率提升百分比等\n【实际影响描述】：对业务、团队、行业产生的可验证价值',
}

/** 活动地点必填的积分项目（专家调用三项为必填，积分自提为选填） */
export const ACTIVITY_LOCATION_REQUIRED_ITEMS = new Set(['技术评审', '人才评审', '技术支持'])
